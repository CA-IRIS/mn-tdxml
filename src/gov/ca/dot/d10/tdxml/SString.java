...
public class SString {
    ...
    static public String toRightField(String f,String s) {
        if( !Contract.verify("SString.toRightField: arg f or s is null.",f!=null && s!=null) )
            return("");
        if( !Contract.verify("SString.toRightField: arg length problem:"+f+","+s,f.length()>=s.length()) )
            return(f);
