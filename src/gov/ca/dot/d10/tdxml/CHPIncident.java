...
public class CHPIncident implements Incident {
	...
	private String m_messageId="";                          // CHP id for the incident. e.g. "0132D0130"
    private String m_area="";                               // <Area> e.g. "Bakersfield"
    private String m_locationDesc="";                       // <Location> e.g. "NB SR99 JSO S UNION AV"
    private String m_type="";                               // <LogType> e.g. "1125A - Traffic Hazard - Animal"
    private String m_areaTB="";                             // <ThomasBrothers> e.g. "22 2C"
	private CHPLocation m_startLoca=new CHPLocation();      // <TBXY> e.g. "6261858:2249615"
	private CHPLocation m_endLoca=null;                     // not used
    private IncidentDescription m_desc=null;                // description
	private EventTime m_eventtime=new CHPEventTime();       // event time <LogTime>
	...
	public boolean isValid()
    {
        ...
        // location valid?
        valid=valid && ((CHPLocation)this.getStartLocation()).isValid();
	...
	public IncidentDescription getDescription()
    {
        ...
        String sign="";
		IncidentDescription id=new IncidentDescription(dir,
			roadway, message,location,extent,time,sign);
	...
	public String toString() {
        ...
        b.append("  ").append(this.getLocationDesc()).append(", ").append(this.getArea()).append(",\n");
        b.append("  ").append(this.getTime().toString()).append(",\n");
        b.append("  TB Area:").append(this.getAreaTB()).append(", ").append(this.getStartLocation().toString());
