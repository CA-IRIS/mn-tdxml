...
public class Transform {
	...
	/** 
 	 ...
 	 * degrees.
	 */
	public static double[] toLatLong(double easting, double northing, int utmZone, boolean northernHemisphere) {
		...
		latLong[0] = Math.toDegrees(phi);
		latLong[1] = Math.toDegrees(lambda);

		return latLong; 
	}

	public static double[] toUtm(double latitude, double longitude, double utmZone) {
