...
/**
 * This class was developed to test the installation of the ddsClient package.
 *
...
public class Main {
	...
	private String propertyFile = "ddsClient.properties";

	/** The DDS stream to connect to */
